...
export default SignUpNavigator = () => {
  return (
    <Stack.Navigator>
      <Stack.Screen 
        name="SignUpScreenSelect" 
        component={SignUpScreenSelect} 
        options={{ 
          headerShown: false,
          presentation: "modal",
      ...
      />
      <Stack.Screen 
        name="SignUpScreenAgreement" 
        component={SignUpScreenAgreement} 
        options={{ 
          headerShown: false,
          presentation: "modal",
          animationTypeForReplace: "push",
      ...
      />
      <Stack.Screen 
        name="SignUpScreenFillInfo" 
        component={SignUpScreenFillInfo} 
        options={{ 
          headerShown: false,
          presentation: "modal",
          animationTypeForReplace: "push",
      ...
      />
      <Stack.Screen 
        name="SignUpScreenComplete" 
        component={SignUpScreenComplete} 
        options={{ 
          headerShown: false,
          presentation: "modal",
          animationTypeForReplace: "push",
